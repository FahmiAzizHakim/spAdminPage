<div class="row">
	<div class="col-md-12">
        <a href="#" class="btn btn-primary btn-block btn-flat" data-toggle="modal" data-target="#tambahRole" onclick="reset_value()"><i class="fa fa-plus"></i> Tambahkan</a>
        <br/>
...
<!-- Modal -->
<div class="modal fade" id="tambahRole" tabindex="-1" role="dialog" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-3">Kode Role</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nm_role" name="nm_role">
                    </div>
                </div>
