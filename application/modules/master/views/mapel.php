<div class="row">
	<div class="col-md-12">
        <a href="#" class="btn btn-primary btn-block btn-flat" data-toggle="modal" data-target="#tambahmapel" onclick="reset_value()"><i class="fa fa-plus"></i> Tambahkan</a>
        <br/>
...
<!-- Modal -->
<div class="modal fade" id="tambahmapel" tabindex="-1" role="dialog" 
