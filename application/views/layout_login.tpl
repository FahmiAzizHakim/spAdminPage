...
<head>
  ...
  <link rel="stylesheet" href="{$assets_url}adminlte/bower_components/datatables.net-bs/css/buttons.dataTables.min.css">
  <!-- Ionicons -->
  ...
  <!-- dropzonejs -->
  <link rel="stylesheet" href="{$assets_url}dropzonejs/dropzone.css">
  <!-- ekko-lightbox -->
  <link rel="stylesheet" href="{$assets_url}ekko-lightbox/ekko-lightbox.min.css">
  <!-- sweetalert2 -->
  <link rel="stylesheet" href="{$assets_url}sweetalert2/sweetalert2.min.css">
  <link rel="stylesheet" href="{$assets_url}adminlte/plugins/pace/pace.min.css">
  <!-- Morris charts -->
  <link rel="stylesheet" href="{$assets_url}adminlte/bower_components/morris.js/morris.css">
...
<script>
    ...
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/dataTables.buttons.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/dataTables.responsive.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/buttons.flash.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/buttons.html5.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/buttons.print.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/jszip.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/pdfmake.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/datatables.net-bs/js/vfs_fonts.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
    ...
    <!-- dropzonejs -->
    <script src="{$assets_url}dropzonejs/dropzone.min.js"></script>
    <!-- ekko-lightbox -->
    <script src="{$assets_url}ekko-lightbox/ekko-lightbox.min.js"></script>
    <!-- jquery loading overlay -->
    <script src="{$assets_url}jquery-loading-overlay/loadingoverlay.min.js"></script>
    <script src="{$assets_url}jquery-loading-overlay/loadingoverlay_progress.min.js"></script>
    <!-- Morris.js charts -->
    <script src="{$assets_url}adminlte/bower_components/raphael/raphael.min.js"></script>
    <script src="{$assets_url}adminlte/bower_components/morris.js/morris.min.js"></script>
    <!-- sweetalert2 -->
    <script src="{$assets_url}sweetalert2/sweetalert2.min.js"></script>
